...
class OptionChainSlice:
    def __init__(
        ...
        ts_event: int = 0,
        ts_init: int = 0,
        atm_price: Price | None = None,
        atm_instrument_id: InstrumentId | None = None,
        listed_strikes: typing.Sequence[Price] | None = None,
    ) -> None: ...
    @property
    ...
    @property
    def atm_price(self) -> Price | None: ...
    @property
    def atm_instrument_id(self) -> InstrumentId | None: ...
    @property
    def ts_event(self) -> int: ...
    @property
    def ts_init(self) -> int: ...
    ...
    def listed_strikes(self) -> list[Price]: ...
    ...
    def get_call_atm_offset(self, offset: int) -> OptionStrikeData | None: ...
    def get_put_atm_offset(self, offset: int) -> OptionStrikeData | None: ...
    def get_call_listed_offset(self, offset: int) -> OptionStrikeData | None: ...
    def get_put_listed_offset(self, offset: int) -> OptionStrikeData | None: ...
...
class OptionSeriesId:
    ...
    @staticmethod
    def from_option_contract(option: OptionContract) -> OptionSeriesId: ...
    @staticmethod
